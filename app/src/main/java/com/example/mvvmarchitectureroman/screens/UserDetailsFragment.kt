...
import com.example.mvvmarchitectureroman.databinding.FragmentUserDetailsBinding
...
class UserDetailsFragment : Fragment() {
    ...
    private val viewModel: UserDetailsViewModel by viewModels {
        creator {
            UserDetailsViewModel(it.usersServices, requireArguments().getLong(ARG_USER_ID) )
        }
    }
